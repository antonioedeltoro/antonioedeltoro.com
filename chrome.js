...
(function () {
  ...
  var navItems   = LINKS.map(function (l) { return '<li><a href="' + l.href + '">' + label(l) + '</a></li>'; }).join('');
  var menuItems  = LINKS.map(function (l) { return '<a href="' + l.href + '">' + label(l) + '</a>'; }).join('');

  var NAV =
    '<nav>' +
      '<a href="/" class="nav-logo">Antonio E<span>.</span> del Toro</a>' +
    ...
    '<footer class="site-footer">' +
      '<div class="site-footer-inner">' +
        ...
        '<div class="footer-links">' +
          ...
          '<a href="/#work">' + label(LINKS[0]) + '</a>' +
          '<a href="/#about">' + label(LINKS[1]) + '</a>' +
          '<a href="/#contact">' + label(LINKS[5]) + '</a>' +
  ...
  function init() {
    replace('site-nav', NAV);
    replace('site-footer', FOOTER);

    var root = document.documentElement;

    // Footer top-divider only on pages without their own <section> dividers (i.e. the legal pages)
